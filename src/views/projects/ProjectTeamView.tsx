...
import { deleteTeamMemberById, getAllMembers } from "@/api/TeamAPI";
...
export default function ProjectTeamView() {
    ...
    const { mutate } = useMutation({
        mutationFn: deleteTeamMemberById,
        onError: (error) => {
    ...
    if(data) return (
        <>
            ...
            <p className="text-2xl font-light text-gray-500 mt-5">Administra el equipo de trabajo paraeste proyecto</p>
