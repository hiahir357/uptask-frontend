...
import { updateCurrentPassword } from "@/api/ProfileAPI";
...
export default function ChangePasswordView() {
    ...
    const { register, handleSubmit, watch, formState: { errors } } = useForm<ChangePasswordForm>({ defaultValues: initialValues })
