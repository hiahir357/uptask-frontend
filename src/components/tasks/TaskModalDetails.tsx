                        ...
                        <div className="flex min-h-full items-center justify-center p-4 text-center">
                            ...
                            >
                                <Dialog.Panel className="w-full max-w-4xl transform overflow-hidden rounded-2xl bg-white text-left align-middle shadow-xl transition-all p-16">
                                    <p className='text-sm text-slate-400'>Agregada el: {""}
                                        <span className='text-emerald-600'>{formatDate(data.createdAt)}</span>
                                    </p>
                                    <p className='text-sm text-slate-400'>Última actualización: {""}
                                        <span className='text-purple-600'>{formatDate(data.updatedAt)}</span>
                                    </p>
                                    <Dialog.Title
                                        as="h3"
