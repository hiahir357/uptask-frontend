...
export default function TaskCard({ task, canEdit }: TaskCardProps) {
    ...
    return (
        <li className="p-5 bg-white border-slate-300 flex justify-between gap-3 relative">
            <div
                {...listeners}
                {...attributes}
                ref={setNodeRef}
                ...
                <PaperClipIcon
                    className="mx-auto size-10 -mt-3 rounded-full p-2 bg-gray-100 text-fuchsia-600 font-bold"
                />
            </div>
            <div
                // {...listeners}
